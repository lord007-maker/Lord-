...
module.exports = {
    SESSION_ID: process.env.SESSION_ID || "ANJU-XPRO~CIcVCR4A#y9oZocErW85h5BkaWuFvjZzV9C8YXeT7_PLxJKbJXDo",
    ...
    SUDO: process.env.SUDO ? process.env.SUDO.split(",") : ["50941475711", "50941475711"],
